...
$(function () {
    ...
    if(loca.lastIndexOf("index.jsp") >= 0)
    {
    	mNow = 0;
    }else if(loca.lastIndexOf("er.jsp") >= 0)
    {
    	mNow = 1;
    }else if(loca.lastIndexOf("help.jsp") >= 0)
    {
    	mNow = 2;
    }else if(loca.lastIndexOf("index.jsp") >= 0)
    {
    	mNow = 3;
    }
    //给定 thisli 默认位置
    ...
    function MenuMove(tn, lefts, move) {
        ...
        if (move === 1) {
            thisMenu.stop();
            thisMenu.animate({ left: lefts + 103 * ti + "px" }, 165)
